...
export async function approveNodePairing(
  ...
  return await withLock(async () => {
    ...
    const node: NodePairingPairedNode = {
      ...
      fileAccess: pending.fileAccess ?? existing?.fileAccess,
...
export async function updatePairedNodeMetadata(
  ...
  await withLock(async () => {
    ...
    const next: NodePairingPairedNode = {
      ...
      fileAccess: patch.fileAccess ?? existing.fileAccess,
      tagFileAccess: patch.tagFileAccess ?? existing.tagFileAccess,
