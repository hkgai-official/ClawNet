...
import { handleBlobHttpRequest } from "./blob-http.js";
...
export function createGatewayHttpServer(opts: {
  ...
  /** Ephemeral blob store for large binary transfers between Nodes and agents. */
  blobStore?: BlobStore;
}): HttpServer {
  const {
    canvasHost,
  ...
  async function handleRequest(req: IncomingMessage, res: ServerResponse) {
    ...
    try {
      ...
      if (
        opts.blobStore &&
        (await handleBlobHttpRequest(req, res, {
