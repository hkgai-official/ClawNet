...
const OPS_COMMANDS = ["ops.log", "ops.undo", "ops.rollback"];

const SYSTEM_COMMANDS = ["system.run", "system.which", "system.notify", "browser.proxy"];

// macOS-specific: file + ops commands without system.run (removed from macOS companion app)
const MACOS_SYSTEM_COMMANDS = ["system.which", "system.notify", "browser.proxy"];
