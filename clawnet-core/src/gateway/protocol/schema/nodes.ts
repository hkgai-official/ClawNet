...
export const NodeUnpairParamsSchema = Type.Object(
  { nodeId: NonEmptyString },
  { additionalProperties: false },
);
...
const FileAccessSchema = Type.Object({
  mode: Type.String(),
...
export const NodeProxyRegisterParamsSchema = Type.Object(
  {
    nodeId: NonEmptyString,
    ...
    platform: Type.Optional(NonEmptyString),
    deviceFamily: Type.Optional(NonEmptyString),
    fileAccess: Type.Optional(FileAccessSchema),
    tagFileAccess: Type.Optional(
      Type.Record(
        Type.String(),
        Type.Object({
...
export const NodeProxyUnregisterParamsSchema = Type.Object(
  {
    nodeId: NonEmptyString,
  },
  { additionalProperties: false },
