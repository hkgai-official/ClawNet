...
import {
  ...
  type NodeProxyRegisterParams,
  NodeProxyRegisterParamsSchema,
  type NodeProxyUnregisterParams,
  NodeProxyUnregisterParamsSchema,
  ...
  type NodeUnpairParams,
  NodeUnpairParamsSchema,
...
export const validateNodeUnpairParams = ajv.compile<NodeUnpairParams>(NodeUnpairParamsSchema);
...
export const validateNodeProxyRegisterParams = ajv.compile<NodeProxyRegisterParams>(
  NodeProxyRegisterParamsSchema,
);
export const validateNodeProxyUnregisterParams = ajv.compile<NodeProxyUnregisterParams>(
  NodeProxyUnregisterParamsSchema,
);
