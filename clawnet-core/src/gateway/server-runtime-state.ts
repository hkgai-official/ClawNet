...
import { registerBoundaryViolationBroadcast } from "../agents/boundary-violation.js";
...
export async function createGatewayRuntimeState(params: {
  ...
  // Register broadcast for boundary violation audit events.
  registerBoundaryViolationBroadcast(broadcast);
