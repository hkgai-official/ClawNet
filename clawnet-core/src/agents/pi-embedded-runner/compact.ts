...
export async function compactEmbeddedPiSessionDirect(
  ...
  try {
    ...
    // Resolve tag workspace ID for system prompt boundary guidance
    const compactTagCtx = params.sessionKey ? getSessionTagContext(params.sessionKey) : undefined;
    ...
    const appendPrompt = buildEmbeddedSystemPrompt({
      ...
      messageToolHints,
      sandboxInfo,
      tagWorkspaceId: compactTagCtx?.workspaceId,
      a2aMode: compactTagCtx?.a2aMode,
      tools,
